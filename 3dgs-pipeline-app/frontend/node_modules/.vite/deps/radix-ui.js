...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React77 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState35 = React77.useState, useEffect40 = React77.useEffect, useLayoutEffect6 = React77.useLayoutEffect, useDebugValue = React77.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var PasswordToggleField = ({
  ...
  const [inputIdState, setInputIdState] = React58.useState(defaultInputId);
  const inputId = inputIdState ?? defaultInputId;
  const syncInputId = React58.useCallback(
  ...
  const focusState = React58.useRef(INITIAL_FOCUS_STATE);
...
var PasswordToggleFieldInput = React58.forwardRef(
  ({
    __scopePasswordToggleField,
...
var PasswordToggleFieldToggle = React58.forwardRef(
  ({
    __scopePasswordToggleField,
    onClick,
    onPointerDown,
    ...
    const [internalAriaLabel, setInternalAriaLabel] = React58.useState(void 0);
...
var PasswordToggleFieldIcon = React58.forwardRef(
  ({
    __scopePasswordToggleField,
    // @ts-expect-error
    children,
...
function createSlot6(ownerName) {
  ...
  const Slot22 = React59.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime36.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React59.isValidElement(newElement) ? React59.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable6(child) {
  return React59.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER6;
}
...
var Progress = React61.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime38.jsx)(ProgressProvider, { scope: __scopeProgress, value, max: max2, children: (0, import_jsx_runtime38.jsx)(
      Primitive.div,
      {
        "aria-valuemax": max2,
        "aria-valuemin": 0,
...
function createSlot7(ownerName) {
  ...
  const Slot22 = React64.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime42.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React64.isValidElement(newElement) ? React64.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable7(child) {
  return React64.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER7;
}
...
var Select = (props) => {
  ...
  const [valueNode, setValueNode] = React65.useState(null);
  const [valueNodeHasChildren, setValueNodeHasChildren] = React65.useState(false);
  const direction = useDirection(dir);
  const [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen ?? false,
  ...
  const triggerPointerDownPosRef = React65.useRef(null);
  const isFormControl2 = trigger ? form || !!trigger.closest("form") : true;
  const [nativeOptionsSet, setNativeOptionsSet] = React65.useState(/* @__PURE__ */ new Set());
      ...
      children: [
        (0, import_jsx_runtime43.jsx)(Collection7.Provider, { scope: __scopeSelect, children: (0, import_jsx_runtime43.jsx)(
          SelectNativeOptionsProvider,
          {
            ...
            onNativeOptionAdd: React65.useCallback((option) => {
              setNativeOptionsSet((prev) => new Set(prev).add(option));
            }, []),
            onNativeOptionRemove: React65.useCallback((option) => {
...
var SelectTrigger = React65.forwardRef(
  (props, forwardedRef) => {
    ...
    const pointerTypeRef = React65.useRef("touch");
...
var SelectValue = React65.forwardRef(
  (props, forwardedRef) => {
...
var SelectIcon = React65.forwardRef(
  (props, forwardedRef) => {
...
var SelectContent = React65.forwardRef(
  (props, forwardedRef) => {
    const context = useSelectContext(CONTENT_NAME13, props.__scopeSelect);
    const [fragment, setFragment] = React65.useState();
    useLayoutEffect2(() => {
...
var SelectContentImpl = React65.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSelect,
    ...
    const [content, setContent] = React65.useState(null);
    const [viewport, setViewport] = React65.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setContent(node));
    const [selectedItem, setSelectedItem] = React65.useState(null);
    const [selectedItemText, setSelectedItemText] = React65.useState(
      null
    );
    const getItems = useCollection7(__scopeSelect);
    const [isPositioned, setIsPositioned] = React65.useState(false);
    const firstValidItemFoundRef = React65.useRef(false);
    React65.useEffect(() => {
      if (content) return hideOthers(content);
    }, [content]);
    useFocusGuards();
    const focusFirst6 = React65.useCallback(
      (candidates) => {
    ...
    const focusSelectedItem = React65.useCallback(
    ...
    const itemRefCallback = React65.useCallback(
      (node, value, disabled) => {
    ...
    const handleItemLeave = React65.useCallback(() => content == null ? void 0 : content.focus(), [content]);
    const itemTextRefCallback = React65.useCallback(
      (node, value, disabled) => {
        const isFirstValidItem = !firstValidItemFoundRef.current && !disabled;
        const isSelectedItem = context.value !== void 0 && context.value === value;
        if (isSelectedItem || isFirstValidItem) {
...
var SelectItemAlignedPosition = React65.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, onPlaced, ...popperProps } = props;
  const context = useSelectContext(CONTENT_NAME13, __scopeSelect);
  const contentContext = useSelectContentContext(CONTENT_NAME13, __scopeSelect);
  const [contentWrapper, setContentWrapper] = React65.useState(null);
  const [content, setContent] = React65.useState(null);
  const composedRefs = useComposedRefs(forwardedRef, (node) => setContent(node));
  const getItems = useCollection7(__scopeSelect);
  const shouldExpandOnScrollRef = React65.useRef(false);
  const shouldRepositionRef = React65.useRef(true);
  const { viewport, selectedItem, selectedItemText, focusSelectedItem } = contentContext;
  const position = React65.useCallback(() => {
  ...
  const [contentZIndex, setContentZIndex] = React65.useState();
  useLayoutEffect2(() => {
    if (content) setContentZIndex(window.getComputedStyle(content).zIndex);
  }, [content]);
  const handleScrollButtonChange = React65.useCallback(
    (node) => {
...
var SelectPopperPosition = React65.forwardRef((props, forwardedRef) => {
  const {
    __scopeSelect,
    align = "start",
...
var SelectViewport = React65.forwardRef(
  (props, forwardedRef) => {
    ...
    const prevScrollTopRef = React65.useRef(0);
...
var SelectGroup = React65.forwardRef(
  (props, forwardedRef) => {
...
var SelectLabel = React65.forwardRef(
  (props, forwardedRef) => {
...
var SelectItem = React65.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSelect,
      value,
    ...
    const [textValue, setTextValue] = React65.useState(textValueProp ?? "");
    ...
    return (0, import_jsx_runtime43.jsx)(
      SelectItemContextProvider,
      {
        ...
        textId,
        isSelected,
        onItemTextChange: React65.useCallback((node) => {
...
var SelectItemText = React65.forwardRef(
  (props, forwardedRef) => {
    ...
    const [itemTextNode, setItemTextNode] = React65.useState(null);
    const composedRefs = useComposedRefs(
      forwardedRef,
    ...
    const nativeOption = React65.useMemo(
...
var SelectItemIndicator = React65.forwardRef(
  (props, forwardedRef) => {
...
var SelectScrollUpButton = React65.forwardRef((props, forwardedRef) => {
  const contentContext = useSelectContentContext(SCROLL_UP_BUTTON_NAME, props.__scopeSelect);
  const viewportContext = useSelectViewportContext(SCROLL_UP_BUTTON_NAME, props.__scopeSelect);
  const [canScrollUp, setCanScrollUp] = React65.useState(false);
...
var SelectScrollDownButton = React65.forwardRef((props, forwardedRef) => {
  const contentContext = useSelectContentContext(SCROLL_DOWN_BUTTON_NAME, props.__scopeSelect);
  const viewportContext = useSelectViewportContext(SCROLL_DOWN_BUTTON_NAME, props.__scopeSelect);
  const [canScrollDown, setCanScrollDown] = React65.useState(false);
  const composedRefs = useComposedRefs(forwardedRef, viewportContext.onScrollButtonChange);
  useLayoutEffect2(() => {
    if (contentContext.viewport && contentContext.isPositioned) {
      let handleScroll22 = function() {
...
var SelectScrollButtonImpl = React65.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, onAutoScroll, ...scrollIndicatorProps } = props;
  const contentContext = useSelectContentContext("SelectScrollButton", __scopeSelect);
  const autoScrollTimerRef = React65.useRef(null);
  const getItems = useCollection7(__scopeSelect);
  const clearAutoScrollTimer = React65.useCallback(() => {
...
var SelectSeparator = React65.forwardRef(
  (props, forwardedRef) => {
...
var SelectArrow = React65.forwardRef(
  (props, forwardedRef) => {
...
var SelectBubbleInput = React65.forwardRef(
...
function useTypeaheadSearch(onSearchChange) {
  ...
  const searchRef = React65.useRef("");
  const timerRef = React65.useRef(0);
  const handleTypeaheadSearch = React65.useCallback(
    (key) => {
      const search = searchRef.current + key;
  ...
  const resetTypeahead = React65.useCallback(() => {
    searchRef.current = "";
    window.clearTimeout(timerRef.current);
  }, []);
  React65.useEffect(() => {
...
var Separator4 = React66.forwardRef((props, forwardedRef) => {
...
var Slider = React67.forwardRef(
  (props, forwardedRef) => {
    ...
    const thumbRefs = React67.useRef(/* @__PURE__ */ new Set());
    const valueIndexToChangeRef = React67.useRef(0);
    ...
    const valuesBeforeSlideStartRef = React67.useRef(values);
...
var SliderHorizontal = React67.forwardRef(
  (props, forwardedRef) => {
    const {
      min: min2,
      max: max2,
    ...
    const [slider, setSlider] = React67.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setSlider(node));
    const rectRef = React67.useRef(void 0);
    const direction = useDirection(dir);
    const isDirectionLTR = direction === "ltr";
...
var SliderVertical = React67.forwardRef(
  (props, forwardedRef) => {
    const {
      min: min2,
      max: max2,
...
var SliderImpl = React67.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSlider,
      onSlideStart,
...
var SliderTrack = React67.forwardRef(
  (props, forwardedRef) => {
...
var SliderRange = React67.forwardRef(
  (props, forwardedRef) => {
...
var SliderThumb = React67.forwardRef(
  (props, forwardedRef) => {
    const getItems = useCollection8(props.__scopeSlider);
    const [thumb, setThumb] = React67.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setThumb(node));
    const index2 = React67.useMemo(
      () => thumb ? getItems().findIndex((item) => item.ref.current === thumb) : -1,
      [getItems, thumb]
    );
    return (0, import_jsx_runtime45.jsx)(SliderThumbImpl, { ...props, ref: composedRefs, index: index2 });
  }
);
var SliderThumbImpl = React67.forwardRef(
  (props, forwardedRef) => {
...
var SliderBubbleInput = React67.forwardRef(
...
function createSlot8(ownerName) {
  ...
  const Slot22 = React68.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime46.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React68.isValidElement(newElement) ? React68.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable8(child) {
  return React68.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER8;
}
...
var SwitchThumb = React69.forwardRef(
  (props, forwardedRef) => {
...
var SwitchBubbleInput = React69.forwardRef(
  ({
    __scopeSwitch,
    control,
    checked,
...
var TabsList = React70.forwardRef(
  (props, forwardedRef) => {
...
var TabsTrigger = React70.forwardRef(
  (props, forwardedRef) => {
...
var TabsContent = React70.forwardRef(
  (props, forwardedRef) => {
    ...
    const contentId = makeContentId2(context.baseId, value);
    const isSelected = value === context.value;
    const isMountAnimationPreventedRef = React70.useRef(isSelected);
    React70.useEffect(() => {
      const rAF = requestAnimationFrame(() => isMountAnimationPreventedRef.current = false);
      return () => cancelAnimationFrame(rAF);
    }, []);
...
var ToastProvider = (props) => {
  ...
  const [toastCount, setToastCount] = React71.useState(0);
  const isFocusedToastEscapeKeyDownRef = React71.useRef(false);
  const isClosePausedRef = React71.useRef(false);
  if (!label.trim()) {
    console.error(
  ...
  return (0, import_jsx_runtime49.jsx)(Collection9.Provider, { scope: __scopeToast, children: (0, import_jsx_runtime49.jsx)(
    ToastProviderProvider,
    {
      ...
      viewport,
      onViewportChange: setViewport,
      onToastAdd: React71.useCallback(() => setToastCount((prevCount) => prevCount + 1), []),
      onToastRemove: React71.useCallback(() => setToastCount((prevCount) => prevCount - 1), []),
...
var ToastViewport = React71.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeToast,
    ...
    const headFocusProxyRef = React71.useRef(null);
    const tailFocusProxyRef = React71.useRef(null);
    ...
    const getSortedTabbableCandidates = React71.useCallback(
      ({ tabbingDirection }) => {
...
var FocusProxy = React71.forwardRef(
  (props, forwardedRef) => {
...
var ToastImpl = React71.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeToast,
      type = "foreground",
    ...
    const [node, setNode] = React71.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node2) => setNode(node2));
    const pointerStartRef = React71.useRef(null);
    const swipeDeltaRef = React71.useRef(null);
    const duration = durationProp || context.duration;
    const closeTimerStartTimeRef = React71.useRef(0);
    const closeTimerRemainingTimeRef = React71.useRef(duration);
    ...
    const startTimer = React71.useCallback(
      (duration2) => {
    ...
    const announceTextContent = React71.useMemo(() => {
    ...
    return (0, import_jsx_runtime49.jsxs)(import_jsx_runtime49.Fragment, { children: [
      ...
      (0, import_jsx_runtime49.jsx)(ToastInteractiveProvider, { scope: __scopeToast, onClose: handleClose, children: ReactDOM6.createPortal(
...
var ToastAnnounce = (props) => {
  ...
  const context = useToastProviderContext(TOAST_NAME, __scopeToast);
  const [renderAnnounceText, setRenderAnnounceText] = React71.useState(false);
  const [isAnnounced, setIsAnnounced] = React71.useState(false);
...
var ToastTitle = React71.forwardRef(
  (props, forwardedRef) => {
...
var ToastDescription = React71.forwardRef(
  (props, forwardedRef) => {
...
var ToastAction = React71.forwardRef(
  (props, forwardedRef) => {
...
var ToastClose = React71.forwardRef(
  (props, forwardedRef) => {
...
var ToastAnnounceExclude = React71.forwardRef((props, forwardedRef) => {
...
var NAME7 = "Toggle";
var Toggle = React72.forwardRef((props, forwardedRef) => {
...
var Toolbar = React74.forwardRef(
  (props, forwardedRef) => {
    ...
    const direction = useDirection(dir);
    return (0, import_jsx_runtime52.jsx)(ToolbarProvider, { scope: __scopeToolbar, orientation, dir: direction, children: (0, import_jsx_runtime52.jsx)(
      Root10,
      {
        asChild: true,
        ...rovingFocusGroupScope,
...
var ToolbarButton = React74.forwardRef(
  (props, forwardedRef) => {
    ...
    const rovingFocusGroupScope = useRovingFocusGroupScope7(__scopeToolbar);
    return (0, import_jsx_runtime52.jsx)(Item2, { asChild: true, ...rovingFocusGroupScope, focusable: !props.disabled, children: (0, import_jsx_runtime52.jsx)(Primitive.button, { type: "button", ...buttonProps, ref: forwardedRef }) });
  }
);
...
var ToolbarLink = React74.forwardRef(
  (props, forwardedRef) => {
    ...
    const rovingFocusGroupScope = useRovingFocusGroupScope7(__scopeToolbar);
    return (0, import_jsx_runtime52.jsx)(Item2, { asChild: true, ...rovingFocusGroupScope, focusable: true, children: (0, import_jsx_runtime52.jsx)(
      Primitive.a,
      {
        ...linkProps,
        ref: forwardedRef,
...
var ToolbarToggleItem = React74.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime52.jsx)(ToolbarButton, { asChild: true, ...scope, children: (0, import_jsx_runtime52.jsx)(Item26, { ...toggleGroupScope, ...toggleItemProps, ref: forwardedRef }) });
  }
);
...
function createSlot9(ownerName) {
  ...
  const Slot22 = React75.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime53.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React75.isValidElement(newElement) ? React75.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable9(child) {
  return React75.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER9;
}
...
var Tooltip = (props) => {
  ...
  return (0, import_jsx_runtime54.jsx)(Root25, { ...popperScope, children: (0, import_jsx_runtime54.jsx)(
...
var TooltipPortal = (props) => {
  ...
  return (0, import_jsx_runtime54.jsx)(PortalProvider5, { scope: __scopeTooltip, forceMount, children: (0, import_jsx_runtime54.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime54.jsx)(Portal, { asChild: true, container, children }) }) });
};
...
var TooltipContent = React76.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime54.jsx)(Presence, { present: forceMount || context.open, children: context.disableHoverableContent ? (0, import_jsx_runtime54.jsx)(TooltipContentImpl, { side, ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime54.jsx)(TooltipContentHoverable, { side, ...contentProps, ref: forwardedRef }) });
  }
);
var TooltipContentHoverable = React76.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime54.jsx)(TooltipContentImpl, { ...props, ref: composedRefs });
});
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime54.jsx)(
      DismissableLayer,
      {
        ...
        onFocusOutside: (event) => event.preventDefault(),
        onDismiss: onClose,
        children: (0, import_jsx_runtime54.jsxs)(
          Content4,
          {
            "data-state": context.stateAttribute,
            ...popperScope,
            ...
            children: [
              (0, import_jsx_runtime54.jsx)(Slottable11, { children }),
              (0, import_jsx_runtime54.jsx)(VisuallyHiddenContentContextProvider, { scope: __scopeTooltip, isInside: true, children: (0, import_jsx_runtime54.jsx)(Root2, { id: context.contentId, role: "tooltip", children: ariaLabel || children }) })
            ]
          }
        )
      }
...
var TooltipArrow = React76.forwardRef(
  (props, forwardedRef) => {
    ...
    return visuallyHiddenContentContext.isInside ? null : (0, import_jsx_runtime54.jsx)(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }
);
